...
| Acao | Arquivo/pasta |
| --- | --- |
| Revisar linguagem dos guias para publico nao tecnico | `00_CENTRAL_ENAJU/*.md` |
...
### 2. Estrategia e Governanca ENAJU
...
| Registrar qual arquivo e a versao mais atual | README ou nota dentro da pasta do artigo |
| Separar documentos de referencia de produtos finais | `Inputs/`, `Fontes/`, `Outputs/` |
...
| O inventario precisa ser atualizado? |  |
...
| Qual cadencia de revisao da carteira | Mantem o portfolio vivo | Pendente |
